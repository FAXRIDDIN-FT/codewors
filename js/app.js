...
class User {
    constructor(ism, familiya, oy, kun, yil, jins, raqam, kod) {
        this.fristname = ism
    ...
    getAge() {
        return `${new Date().getFullYear() - this.oy}`
    }
}
let user1 = new User("akmal", "qodirov", 2004, "male ", "+99812345", "12345678")
...
{//01
    ...
    const bike = new Motorcycle("Yamaha", 2020);
    console.log(bike);
...
{ // 03
    ...
    console.log(`${person1.name} is adult:`, person1.isAdult());
...
class Person {
  ...
  const employee = new Employee("Laylo", 28, "Developer");
...
{ // 07
    class Movie {
      ...
      const movie = new Movie("Interstellar", 2014, 8.6);
